        ...
        NavigationStack {
            List {
                Section("4.3.1") {
                    ...
                    Text(tr("【体验修正】修复中文界面遗留的「工具箱」自称，合并辅助程序重复的安装参数处理",
                            "Fixed the leftover Chinese self-reference to the old app name and merged duplicated helper install argument handling",
                            "中国語 UI に残っていた旧名称の自己表記を修正し、ヘルパーの重複したインストール引数処理を統合しました"))
                }
                Section("4.3.0") {
